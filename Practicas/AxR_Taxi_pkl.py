...
def run(episodes, is_training=True, render=False):
    ...
    if is_training:
        # Inicializa la tabla Q con ceros (500 estados x 6 acciones)
...
if __name__ == '__main__':
    ## ENTRENA EL AGENTE
    run(15000)  # Entrena el agente con 15000 episodios
    
    ## UNA VEZ YA ENTRENADO COMENTA LA LINEA ANTERIOR Y DESCOMENTA LA SIGUIENTE
